...
def select_attention_pointer(
    ...
    *,
    ...
    def _build_pointer(thread: dict, reason: str, *, cooldown_bypassed: bool = False) -> dict:
        ...
        invitation += ' Say "look into it" if you want me to open it.'
        pointer = {
    ...
    def _build_candidate_pointer(candidate: dict, reason: str) -> dict:
        ...
        invitation = (
            ...
            'Say "open it up" or "look into it" if you want me to inspect the attention inbox.'
        )
        return {
            "action": "pointer_available",
...
def pointer_context_for_llm(pointer: dict) -> str:
    ...
    if pointer.get("pointer_type") == "candidate":
        ...
        return (
            ...
            'Internal instruction: If the user says "open it up", "look into it", '
            "or similar, call "
    ...
    return (
        ...
        f"Human-facing doorway: {pointer.get('invitation')}\n"
        'Internal instruction: If the user says "look into it", "open it up", '
        "or similar, call "
