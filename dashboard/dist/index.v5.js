      ...
      !data ? h(Empty, { text: state.loading ? "Loading Sensorium snapshot…" : "No Sensorium snapshot yet." }) : h(React.Fragment, null,
        ...
        activeView === "overview" ? h(React.Fragment, null,
          h("div", { className: "sx-focus-grid" },
            h(Section, { title: "What matters now", subtitle: "Only open pressure and actionable gaps; detailed substrate lives in its own views." },
        ...
        activeView === "actuators" ? h(DrillDown, { title: "Actions, outbox, and artifacts", badge: (counts.open_actions ?? 0) + " open actions", open: true },
          h("div", { className: "sx-grid" },
