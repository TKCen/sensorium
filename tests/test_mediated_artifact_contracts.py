...
def _relational_candidate() -> dict:
    return {
        ...
        "pressure": 0.81,
        "summary": "Operator said this work matters to them; create a tangible artifact handoff, not just routing repair.",
        "event_ids": ["evt_rel"],
        "correlation_keys": ["mediated-presence", "artifact-handoff", "thread-pickup"],
        "fingerprint": "fp_rel",
        "sensitivity": "private",
